...
if (typeof window !== 'undefined') {
  ...
  ovocie: {
    ...
    items: [
      ...
      { id: 'datle', name: 'Ďatle', price: 1.30, color: '#7A4A2A', icon: '🟤', image: '/ingredients/datle.jpg' },
      { id: 'figy', name: 'Figy sušené', price: 2.10, color: '#8B4567', icon: '🟣', image: '/ingredients/figy.jpg' },
      { id: 'goji', name: 'Goji', price: 2.70, color: '#E8623D', icon: '🍎', image: '/ingredients/goji.jpg' },
      ...
      { id: 'slivka', name: 'Slivka sušená', price: 1.90, color: '#4A2A4A', icon: '🔵', image: '/ingredients/slivka.jpg' },
      { id: 'zazvor', name: 'Zázvor kandizovaný', price: 1.60, color: '#E8C57A', icon: '🟨', image: '/ingredients/zazvor.jpg' },
